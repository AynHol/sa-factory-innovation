...
ipcMain.handle("createQualidade", async (_: any, qualidade: any) => {
  const {id, pneu, porta, motor, lataria, interior, farol, veiculo_id} = qualidade;
  const newQualidade = new Qualidade(pneu, porta, motor, lataria, interior, farol, veiculo_id, id);
